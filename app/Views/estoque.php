                ...
                <tbody>
                    <?php foreach ($insumos as $i): ?>
                        <tr>
                            ...
                            <td>
                                <img id="editModal" class="icon-editar" src="public/img/icon-editar.png" href="#"
                                    data-bs-toggle="modal" data-bs-target="#editModal" data-bs-id="<?= $i["id"] ?>"
                                ...
                                <div class="modal-body">
                                    <form>
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="recipient-id" readonly>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="recipient-risco" class="col-form-label">Risco:</label>
                                            <select class="form-control" id="recipient-risco">
                                                <option></option>
                                                <option>🟢 Baixo</option>
                                                <option>🟡 Médio</option>
                                                <option>🔴 Alto</option>
                                        ...
                                        <div class="mb-3">
                                            <label for="recipient-qtde" class="col-form-label">Quantidade
                                                atual:</label>
                                            <input type="number" class="form-control" id="recipient-qtde">
                                        </div>
                                        <div class="mb-3">
                                            <label for="recipient-un-medida" class="col-form-label">Unidade de
                                                medida:</label>
                                            <select class="form-control" id="recipient-un-medida">
                                                <option></option>
                                                <option>kg</option>
                                                <option>g</option>
                                                <option>mg</option>
                                        ...
                                        <div class="mb-3">
                                            <label for="recipient-data-validade" class="col-form-label">Data de
                                                validade:</label>
                                            <input type="date" class="form-control" id="recipient-data-validade">
                                        </div>
                                    </form>
                                </div>
